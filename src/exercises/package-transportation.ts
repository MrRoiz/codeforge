...
export const packageTransportation: Exercise = {
  ...
  functionSignature: 'export function canShipAll(truckCapacities: number[], packageWeights: number[]): number',
  hints: [
